...
function setKeyValue(key, value) {
    var db = openDatabaseSync("Go2Car2Go", "1.0.0", "KeyValueStorage", 10);
...
function deleteTable(callback) {
    var db = openDatabaseSync("Go2Car2Go", "1.0.0", "KeyValueStorage", 10);
    db.transaction(function(tx) {
       tx.executeSql('DELETE TABLE IF EXISTS KeyValueStorage(keyName TEXT, textValue TEXT)');
       var result = "";
       var rs = tx.executeSql('SELECT * FROM KeyValueStorage');
